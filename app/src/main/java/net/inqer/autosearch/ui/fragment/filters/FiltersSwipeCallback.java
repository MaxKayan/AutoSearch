...
abstract public class FiltersSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public FiltersSwipeCallback(Context context) {
        this.mContext = context;
        clearPaint = new Paint();
        clearPaint.setXfermode(new PorterDuffXfermode(PorterDuff.Mode.CLEAR));
        background = new ColorDrawable();
        backgroundColor = Color.parseColor("#b80f0a");
        deleteDrawable = ContextCompat.getDrawable(mContext, R.drawable.ic_delete_forever_red);
